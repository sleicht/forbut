...
#
# Section order mirrors forgit/lib/utils.sh as closely as possible so the two
# files can be diffed side-by-side. Forbut-specific sections (colour palette,
# but wrapper, JSON schema guard) are slotted in where they fit semantically.
...
# ---------------------------------------------------------------------------
# FORBUT_FZF_DEFAULT_OPTS (≈ forgit's FORGIT_FZF_DEFAULT_OPTS)
# ---------------------------------------------------------------------------
# Users can override in their shell config to tweak global forbut fzf
# behaviour. Per-command FORBUT_<CMD>_FZF_OPTS still layer on top via
# _forbut_fzf.
...
# ---------------------------------------------------------------------------
# Colour palette (forbut-specific — forgit uses inline ANSI codes in helpers)
# ---------------------------------------------------------------------------
# Defined early because logging helpers below reference these vars.
if [[ -t 1 ]]; then
...
# ---------------------------------------------------------------------------
# Repo guard (≈ forgit's _forgit_inside_work_tree)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Text primitives (≈ forgit's _forgit_reverse_lines / _forgit_strip_ansi)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Array parsing (≈ forgit's _forgit_parse_array)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# File listing (≈ forgit's _forgit_list_files / _forgit_worktree_changes)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Pager resolution (≈ forgit's _forgit_pager / _forgit_preview / _forgit_get_pager)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Preview dispatcher (≈ forgit's _forgit_preview)
# ---------------------------------------------------------------------------
...
# ===========================================================================
# Below this line: forbut-specific sections that have no direct forgit analog.
# Kept after the forgit-aligned helpers so the upper portion of this file
# diffs cleanly against forgit/lib/utils.sh.
# ===========================================================================
...
# ---------------------------------------------------------------------------
# fzf wrapper (no direct forgit analog — forgit calls fzf inline per command)
# ---------------------------------------------------------------------------
...
# Global fzf defaults are set via FORBUT_FZF_DEFAULT_OPTS (defined above),
